...
class Program
{
        ...
        string[] args = null)
    {
        return region switch
        {
            ...
            "nested-groupby" => new Groupings().NestedGroupBy(),
            ...
            "group-join" => new JoinOperations().GroupJoinQuery(),
    ...
    private static int RunAll()
    {
        ...
        new SequenceOperations().UnequalSequence();
        ...
        new JoinOperations().GroupJoinQuery();
